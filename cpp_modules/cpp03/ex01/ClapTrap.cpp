...
/*   Updated: 2023/12/04 10:32:47 by rbordin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ClapTrap::attack(const std::string &target)
{
    ...
    std::cout << "causing " << this->attackDmg << " points of damage at cost of 1 energy point!" << std::endl;
}

void    ClapTrap::takeDamage(unsigned int amount)
{
    this->setHitPoints(amount, 0);
    std::cout << "ClapTrap " << this->name << " took " << amount << " of damage after being attacked!" <<std::endl;
}
...
void    ClapTrap::beRepaired(unsigned int amount)
{
    ...
    std::cout << "ClapTrap " << this->name << " rapaired itself and gain " << amount << " resistence for next attacks at cost of 1 energy point!" <<std::endl;
}
